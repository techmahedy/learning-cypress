import googleHomePage from "../support/helper/googleHomePage";

/ <reference types="cypress" / >
  describe("learn about locators", () => {
    const google = new googleHomePage();
    it("interacting with input field", () => {
      google.visitGoogleHomePage();
    });

    it("click on search input field and see suggestion dropdown", () => {
      //clicking on the input field
      google.clickOnGoogleSearchInputField();
    ...
    it("type laravel on the search input field and assert suggestion and click on second result", () => {
